...
const Details1_2 = () => {
  ...
  return (
    <>
      <Component.HeaderPageDetails image={img?.AvailableBg} />
        ...
        <Row className=''>
          ...
          <Col xl={4} lg={4} md={6} sm={12}>
            <div className="btn_ready flex justify-content-end">
              <div className="ready flex flex-row align-items-center justify-content-center gap-4"
                data-aos="zoom-in-up"
                data-aos-duration="1000"
                data-aos-easing="linear">
                <Icons.Time />
                <div className="content  ">
                  <h3 className='m-0 p-0'>{t("architecture_details_btn1")}</h3>
                  {/* <p className='m-0 p-0'>  {t("architecture_details_btn2")}</p> */}
                </div>
              </div>
            </div>
          </Col>
